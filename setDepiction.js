        ...
        success: function (xml) {
            ...
            $(xml).find('packageInfo').each(function(){
                  // document.getElementById("packageTitle").innerHTML = $(this).find("name").text();
                   ...
                   //    document.getElementById("compatibilityIcon").innerHTML = "ðŸ˜€";
                   //
                   // }else {
                   ...
                   //   document.getElementById("compatibilityIcon").innerHTML = "ðŸ˜ž";
                   //
                   // }
                 }else{
                   ...
                   // document.getElementById("compatibilityIcon").innerHTML = "âš ï¸";
